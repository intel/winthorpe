...
#ifndef SPEECH_SPEECH_LOGS_H_
#define SPEECH_SPEECH_LOGS_H_
...
// file logging
extern std::ofstream _s_f_log;

#define LOG_INIT()   _s_f_log.open("xwalk_ext_speech.log")
#define LOG_CLOSE()  _s_f_log.close()
